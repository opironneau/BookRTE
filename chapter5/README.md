...
The VRTE of chapter 4 are valid for a piecewise constant refractive index $n$ if $I,Q$ are replaced by $\tilde I=I/n, \tilde Q=Q/n$. The programs deal with the case $n=n_-$ in $(0,Y)$ and and $n=n^+$ in $(Y,Z)$.  The difficulty is that the Fresnel transmission conditions at $z=Y$ are quite complex. They are implemented in snell2.edp (FreeFem++)
